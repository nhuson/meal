...
class ContactService extends BaseService {
  ...
  async getContactAvailable(option) {
    ...
    let contacts = await this.db.select('contacts.created_at', this.db.raw("CONCAT(users.firstname, ' ', users.lastname) as fullname") ,'users.email', 'contacts.title','contacts.messages')
              .from('contacts')
